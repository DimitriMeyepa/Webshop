...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM produit WHERE genreprod = 'femme' ORDER BY dateajoutprod DESC");
    $stmt->execute();
    ...
    foreach ($products as &$p) {
        ...
        if ($p['image_principale'] && !file_exists($p['image_principale'])) {
            $p['image_principale'] = 'img/pants/pantalon_leg_wide_noir.jpg'; 
        }
        ...
        <?php foreach ($products as $product): ?>
          <div class="bg-white shadow-lg rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105">
            ...
            <div class="p-4 text-center">
              ...
              <a href="display_women.php?ref=<?php echo $product['referenceprod']; ?>" 

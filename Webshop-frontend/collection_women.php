...
<body>
    ...
    <div class="relative inline-block w-full md:w-1/4" data-aos="fade-down" data-aos-duration="700">
      ...
      <div id="sortMenu"
        ...
        <button data-sort="name-asc"
          class="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100 transition">
          Nom A–Z
        </button>
  ...
  <script>
    ...
    options.forEach((opt) => {
      opt.addEventListener("click", () => {
        options.forEach((o) =>
          o.classList.remove("text-red-500", "bg-red-50")
        );
  ...
  <section class="container mx-auto px-6 py-16">
    <div class="text-center mb-12" data-aos="fade-up">
      ...
      <p class="text-gray-500">Découvrez nos modèles pour femmes</p>
    </div>

    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8" data-aos="fade-up" data-aos-delay="200">
      <div class="bg-white shadow-lg rounded-lg overflow-hidden" data-aos="zoom-in" data-aos-delay="300">
        <img src="img/pants/noir.jpg" alt="pantalon" class="w-full h-80 object-cover object-top product-image" />
